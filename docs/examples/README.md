...
it is sometimes desirable to set the credential ID as annotation.
In order to achieve this you add an attribute `jenkins.io/credentials-id` as set the desired credential ID a the value
